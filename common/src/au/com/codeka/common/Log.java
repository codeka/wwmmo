...
public class Log {
  ...
  public void error(String fmt, Object... args) {
    if (impl == null || !impl.isLoggable(mTag, ERROR)) {
      return;
    }
    impl.write(mTag, ERROR, formatMsg(fmt, args));
  }

  public void warning(String fmt, Object... args) {
    if (impl == null || !impl.isLoggable(mTag, WARNING)) {
      return;
    }
    impl.write(mTag, WARNING, formatMsg(fmt, args));
  }

  public void info(String fmt, Object... args) {
    if (impl == null || !impl.isLoggable(mTag, INFO)) {
      return;
    }
    impl.write(mTag, INFO, formatMsg(fmt, args));
  }

  public void debug(String fmt, Object... args) {
    if (impl == null || !impl.isLoggable(mTag, DEBUG)) {
      return;
    }
    impl.write(mTag, DEBUG, formatMsg(fmt, args));
  }

  public boolean isDebugEnabled() {
    return impl != null && impl.isLoggable(mTag, DEBUG);
  }
