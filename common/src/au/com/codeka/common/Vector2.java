...
public class Vector2 implements ObjectPool.Pooled {
  public static ObjectPool<Vector2> pool = new ObjectPool<>(250, new Vector2Creator());
  ...
  public static Vector2 lerp(Vector2 src, Vector2 dest, float fraction, Vector2 result) {
  ...
  public static Vector2 lerp(Vector2 src, Vector2 dest, float fraction) {
    Vector2 result = new Vector2();
    return lerp(src, dest, fraction, result);
  }
