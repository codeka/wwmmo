...
public abstract class BaseDesignManager {
    ...
    public BuildingDesign getDesign(Building building) {
        return (BuildingDesign) getDesign(DesignKind.BUILDING, building.design_id);
    }

    public ShipDesign getDesign(Fleet fleet) {
        return (ShipDesign) getDesign(DesignKind.SHIP, fleet.design_id);
    }
