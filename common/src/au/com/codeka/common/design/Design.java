...
public class Design {
    ...
    public String getDependenciesList(Star star, Colony colony) {
        return getDependenciesList(star, colony, 1);
    }
     ...
     */
    public String getDependenciesList(Star star, Colony colony, int level) {
        ...
        if (dependencies == null || dependencies.size() == 0) {
            ...
            for (Design.Dependency dep : dependencies) {
                ...
                boolean dependencyMet = dep.isMet(star, colony);
    ...
    public static class Dependency {
        ...
        public boolean isMet(Star star, Colony colony) {
            for (Building building : star.buildings) {
                if (building.colony_key.equals(colony.key) &&
                        building.design_id.equals(mDesignID)) {
