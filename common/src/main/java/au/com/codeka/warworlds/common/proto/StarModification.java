...
// Source file: star.proto at 165:1
...
public final class StarModification extends Message<StarModification, StarModification.Builder> {
  ...
  public StarModification(MODIFICATION_TYPE type, Long empire_id, Integer planet_index, Long colony_id, ColonyFocus focus, String design_id, Integer count) {
    this(type, empire_id, planet_index, colony_id, focus, design_id, count, ByteString.EMPTY);
  }

  public StarModification(MODIFICATION_TYPE type, Long empire_id, Integer planet_index, Long colony_id, ColonyFocus focus, String design_id, Integer count, ByteString unknownFields) {
  ...
  public static final class Builder extends Message.Builder<StarModification, Builder> {
    ...
    public StarModification build() {
      return new StarModification(type, empire_id, planet_index, colony_id, focus, design_id, count, buildUnknownFields());
    }
  }
  ...
  public enum MODIFICATION_TYPE implements WireEnum {
     ...
     * empire_id, design_id and count are required.
     */
    CREATE_FLEET(3);
  ...
  private static final class ProtoAdapter_StarModification extends ProtoAdapter<StarModification> {
    ...
    public int encodedSize(StarModification value) {
      return (value.type != null ? MODIFICATION_TYPE.ADAPTER.encodedSizeWithTag(1, value.type) : 0)
          ...
          + (value.design_id != null ? ProtoAdapter.STRING.encodedSizeWithTag(6, value.design_id) : 0)
    ...
    public void encode(ProtoWriter writer, StarModification value) throws IOException {
      ...
      if (value.design_id != null) ProtoAdapter.STRING.encodeWithTag(writer, 6, value.design_id);
    ...
    public StarModification decode(ProtoReader reader) throws IOException {
      ...
      for (int tag; (tag = reader.nextTag()) != -1;) {
        switch (tag) {
          ...
          case 6: builder.design_id(ProtoAdapter.STRING.decode(reader)); break;
