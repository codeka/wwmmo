...
// Source file: fleet.proto at 6:1
...
public final class Fleet extends Message<Fleet, Fleet.Builder> {
  ...
  public Fleet(Long id, Long empire_id, Long alliance_id, String design_id, Float num_ships, FLEET_STATE state, Long state_start_time, Long destination_star_id, Long target_fleet_id, FLEET_STANCE stance, Long time_destroyed, Boolean block_notification_on_destroy, Long last_victory, Long eta, String notes) {
    this(id, empire_id, alliance_id, design_id, num_ships, state, state_start_time, destination_star_id, target_fleet_id, stance, time_destroyed, block_notification_on_destroy, last_victory, eta, notes, ByteString.EMPTY);
  }

  public Fleet(Long id, Long empire_id, Long alliance_id, String design_id, Float num_ships, FLEET_STATE state, Long state_start_time, Long destination_star_id, Long target_fleet_id, FLEET_STANCE stance, Long time_destroyed, Boolean block_notification_on_destroy, Long last_victory, Long eta, String notes, ByteString unknownFields) {
  ...
  public Builder newBuilder() {
    ...
    builder.time_destroyed = time_destroyed;
  ...
  public boolean equals(Object other) {
    ...
    return Internal.equals(unknownFields(), o.unknownFields())
        ...
        && Internal.equals(time_destroyed, o.time_destroyed)
  ...
  public String toString() {
    ...
    if (time_destroyed != null) builder.append(", time_destroyed=").append(time_destroyed);
  ...
  public static final class Builder extends Message.Builder<Fleet, Builder> {
    ...
    @Override
    public Fleet build() {
      return new Fleet(id, empire_id, alliance_id, design_id, num_ships, state, state_start_time, destination_star_id, target_fleet_id, stance, time_destroyed, block_notification_on_destroy, last_victory, eta, notes, buildUnknownFields());
    }
  }
  ...
  private static final class ProtoAdapter_Fleet extends ProtoAdapter<Fleet> {
    ...
    public int encodedSize(Fleet value) {
      return (value.id != null ? ProtoAdapter.INT64.encodedSizeWithTag(1, value.id) : 0)
          ...
          + (value.design_id != null ? ProtoAdapter.STRING.encodedSizeWithTag(4, value.design_id) : 0)
          ...
          + (value.time_destroyed != null ? ProtoAdapter.INT64.encodedSizeWithTag(11, value.time_destroyed) : 0)
    ...
    public void encode(ProtoWriter writer, Fleet value) throws IOException {
      ...
      if (value.design_id != null) ProtoAdapter.STRING.encodeWithTag(writer, 4, value.design_id);
      ...
      if (value.time_destroyed != null) ProtoAdapter.INT64.encodeWithTag(writer, 11, value.time_destroyed);
    ...
    public Fleet decode(ProtoReader reader) throws IOException {
      ...
      for (int tag; (tag = reader.nextTag()) != -1;) {
        switch (tag) {
          ...
          case 4: builder.design_id(ProtoAdapter.STRING.decode(reader)); break;
          ...
          case 11: builder.time_destroyed(ProtoAdapter.INT64.decode(reader)); break;
