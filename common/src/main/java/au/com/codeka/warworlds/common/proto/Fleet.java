...
// Source file: fleet.proto at 7:1
...
public final class Fleet extends Message<Fleet, Fleet.Builder> {
  ...
  public Fleet(Long id, Long empire_id, Long alliance_id, Design.DesignType design_type, Float num_ships, FLEET_STATE state, Long state_start_time, Long destination_star_id, Long target_fleet_id, FLEET_STANCE stance, Long time_destroyed, Boolean block_notification_on_destroy, Long last_victory, Long eta, String notes) {
    this(id, empire_id, alliance_id, design_type, num_ships, state, state_start_time, destination_star_id, target_fleet_id, stance, time_destroyed, block_notification_on_destroy, last_victory, eta, notes, ByteString.EMPTY);
  }
  ...
  public static final class Builder extends Message.Builder<Fleet, Builder> {
    ...
    @Override
    public Fleet build() {
      return new Fleet(id, empire_id, alliance_id, design_type, num_ships, state, state_start_time, destination_star_id, target_fleet_id, stance, time_destroyed, block_notification_on_destroy, last_victory, eta, notes, buildUnknownFields());
    }
  }
