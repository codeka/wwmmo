...
public class ChatMessage extends BaseChatMessage {
  ...
  /**
   * Formats this message for display. Returns a snippet of HTML with the correct colors and so on.
   */
  public String format(boolean isPublic, boolean messageOnly, boolean autoTranslate) {
    ...
    if (mDatePosted != null && !messageOnly) {
      msg = mDatePosted.withZone(DateTimeZone.getDefault()).toString(CHAT_DATE_FORMAT) + " : " + msg;
    }
