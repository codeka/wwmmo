...
parser.add_argument('--apk', help='If specified, build an APK instead of an AAB (bundle).', action="store_true")
args = parser.parse_args()

if args.apk:
  # Do the build
  os.system("cd " + str(common.rootPath) + " && " + common.gradleCmd + " --daemon :client:assembleRelease")
