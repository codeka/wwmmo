...
public class FleetListRow extends RelativeLayout {
  ...
  public void refresh() {
    ImageView icon = findViewById(R.id.ship_icon);
    final LinearLayout row1 = findViewById(R.id.ship_row1);
    final LinearLayout row2 = findViewById(R.id.ship_row2);
    final LinearLayout row3 = findViewById(R.id.ship_row3);
  ...
  private static void populateFleetDestinationRow(
      Context context, LinearLayout row, Fleet fleet, Star src, Star dest, boolean includeEta) {
  ...
  private static void addImageToRow(
      Context context, LinearLayout row, Sprite sprite, float marginHorz, float marginVert,
      float size) {
    ImageView iv = new ImageView(context);
