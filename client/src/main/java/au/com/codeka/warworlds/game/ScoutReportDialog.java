...
public class ScoutReportDialog extends DialogFragment {
  ...
  public Dialog onCreateDialog(Bundle savedInstanceState) {
    ...
    view = inflater.inflate(R.layout.scout_report_dlg, null);

    final ImageView starIcon = view.findViewById(R.id.star_icon);
    final TextView starName = view.findViewById(R.id.star_name);
    final TextView reportSummary = view.findViewById(R.id.report_summary);
    final View progressBar = view.findViewById(R.id.progress_bar);
    final View reportDate = view.findViewById(R.id.report_date);
    final View newerButton = view.findViewById(R.id.newer_btn);
    final View olderButton = view.findViewById(R.id.older_btn);
    ...
    starIcon.setImageDrawable(new SpriteDrawable(
        StarImageManager.getInstance().getSprite(star, imageSize, true)));
    ...
    reportItems.setAdapter(reportAdapter);

    progressBar.setVisibility(View.VISIBLE);
    reportItems.setVisibility(View.GONE);

    EmpireManager.i.getEmpire().fetchScoutReports(star, new MyEmpire.FetchScoutReportCompleteHandler() {
      @Override
  ...
  private void refreshReports(List<ScoutReport> reports) {
    ...
    Spinner reportDates = view.findViewById(R.id.report_date);
    ...
    if (reports.size() > 0) {
      ...
      reportAdapter.setReport(reports.get(0));
    }
  }
