...
# This is the URL that we'll ping. It's the home star of my test user.
...
PING_URL = "https://game.war-worlds.com/realms/def/stars/287751/simulate?nolog=1&update=1"
