...
// Source file: au/com/codeka/warworlds/common/proto/account.proto at 87:1
...
public final class LoginResponse extends Message<LoginResponse, LoginResponse.Builder> {
  ...
  public static final LoginStatus DEFAULT_STATUS = LoginStatus.LOGINSTATUS_UNKNOWN;
  ...
  @WireField(
      tag = 1,
      adapter = "au.com.codeka.warworlds.common.proto.LoginResponse$LoginStatus#ADAPTER"
  )
  ...
  public LoginResponse(LoginStatus status, String host, Integer port, Empire empire, Boolean require_gcm_register, Boolean force_remove_ads) {
    this(status, host, port, empire, require_gcm_register, force_remove_ads, ByteString.EMPTY);
  }

  public LoginResponse(LoginStatus status, String host, Integer port, Empire empire, Boolean require_gcm_register, Boolean force_remove_ads, ByteString unknownFields) {
  ...
  public static final class Builder extends Message.Builder<LoginResponse, Builder> {
    ...
    public LoginResponse build() {
      return new LoginResponse(status, host, port, empire, require_gcm_register, force_remove_ads, buildUnknownFields());
    }
  }

  public enum LoginStatus implements WireEnum {
    ...
    public static final ProtoAdapter<LoginStatus> ADAPTER = ProtoAdapter.newEnumAdapter(LoginStatus.class);
    ...
    public static LoginStatus fromValue(int value) {
      switch (value) {
        case 0: return LOGINSTATUS_UNKNOWN;
  ...
  private static final class ProtoAdapter_LoginResponse extends ProtoAdapter<LoginResponse> {
    ...
    public int encodedSize(LoginResponse value) {
      return (value.status != null ? LoginStatus.ADAPTER.encodedSizeWithTag(1, value.status) : 0)
          + (value.host != null ? ProtoAdapter.STRING.encodedSizeWithTag(2, value.host) : 0)
          + (value.port != null ? ProtoAdapter.INT32.encodedSizeWithTag(3, value.port) : 0)
          + (value.empire != null ? Empire.ADAPTER.encodedSizeWithTag(4, value.empire) : 0)
          + (value.require_gcm_register != null ? ProtoAdapter.BOOL.encodedSizeWithTag(5, value.require_gcm_register) : 0)
          + (value.force_remove_ads != null ? ProtoAdapter.BOOL.encodedSizeWithTag(6, value.force_remove_ads) : 0)
          + value.unknownFields().size();
    }

    @Override
    public void encode(ProtoWriter writer, LoginResponse value) throws IOException {
      if (value.status != null) LoginStatus.ADAPTER.encodeWithTag(writer, 1, value.status);
      if (value.host != null) ProtoAdapter.STRING.encodeWithTag(writer, 2, value.host);
      if (value.port != null) ProtoAdapter.INT32.encodeWithTag(writer, 3, value.port);
      if (value.empire != null) Empire.ADAPTER.encodeWithTag(writer, 4, value.empire);
      if (value.require_gcm_register != null) ProtoAdapter.BOOL.encodeWithTag(writer, 5, value.require_gcm_register);
      if (value.force_remove_ads != null) ProtoAdapter.BOOL.encodeWithTag(writer, 6, value.force_remove_ads);
    ...
    public LoginResponse decode(ProtoReader reader) throws IOException {
      ...
      for (int tag; (tag = reader.nextTag()) != -1;) {
        switch (tag) {
          case 1: {
            try {
              builder.status(LoginStatus.ADAPTER.decode(reader));
            } catch (ProtoAdapter.EnumConstantNotFoundException e) {
              builder.addUnknownField(tag, FieldEncoding.VARINT, (long) e.value);
            }
            break;
          }
          case 2: builder.host(ProtoAdapter.STRING.decode(reader)); break;
          case 3: builder.port(ProtoAdapter.INT32.decode(reader)); break;
          case 4: builder.empire(Empire.ADAPTER.decode(reader)); break;
          case 5: builder.require_gcm_register(ProtoAdapter.BOOL.decode(reader)); break;
          case 6: builder.force_remove_ads(ProtoAdapter.BOOL.decode(reader)); break;
          default: {
