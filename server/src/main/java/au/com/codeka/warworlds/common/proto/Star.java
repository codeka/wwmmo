...
// Source file: au/com/codeka/warworlds/common/proto/star.proto at 39:1
...
public final class Star extends Message<Star, Star.Builder> {
  ...
  @WireField(
      tag = 14,
      adapter = "au.com.codeka.warworlds.common.proto.EmpireStorage#ADAPTER",
      label = WireField.Label.REPEATED
  )
  ...
  @WireField(
      tag = 21,
      adapter = "au.com.codeka.warworlds.common.proto.CombatReport#ADAPTER",
      label = WireField.Label.REPEATED
  )
  public final List<CombatReport> combat_reports;

  public Star(Long id, Long sector_x, Long sector_y, String name, CLASSIFICATION classification, Integer size, Integer offset_x, Integer offset_y, List<Planet> planets, List<EmpireStorage> empire_stores, List<Fleet> fleets, Long time_emptied, Long last_simulation, Long next_simulation, Wormhole wormhole, List<CombatReport> combat_reports) {
    this(id, sector_x, sector_y, name, classification, size, offset_x, offset_y, planets, empire_stores, fleets, time_emptied, last_simulation, next_simulation, wormhole, combat_reports, ByteString.EMPTY);
  }

  public Star(Long id, Long sector_x, Long sector_y, String name, CLASSIFICATION classification, Integer size, Integer offset_x, Integer offset_y, List<Planet> planets, List<EmpireStorage> empire_stores, List<Fleet> fleets, Long time_emptied, Long last_simulation, Long next_simulation, Wormhole wormhole, List<CombatReport> combat_reports, ByteString unknownFields) {
    ...
    this.empire_stores = Internal.immutableCopyOf("empire_stores", empire_stores);
    ...
    this.combat_reports = Internal.immutableCopyOf("combat_reports", combat_reports);
  }
  ...
  public Builder newBuilder() {
    ...
    builder.empire_stores = Internal.copyOf("empire_stores", empire_stores);
    ...
    builder.combat_reports = Internal.copyOf("combat_reports", combat_reports);
  ...
  public boolean equals(Object other) {
    ...
    return Internal.equals(unknownFields(), o.unknownFields())
        ...
        && Internal.equals(empire_stores, o.empire_stores)
        ...
        && Internal.equals(combat_reports, o.combat_reports);
  }
  ...
  public int hashCode() {
    ...
    if (result == 0) {
      ...
      result = result * 37 + (empire_stores != null ? empire_stores.hashCode() : 1);
      ...
      result = result * 37 + (combat_reports != null ? combat_reports.hashCode() : 1);
  ...
  public String toString() {
    ...
    if (empire_stores != null) builder.append(", empire_stores=").append(empire_stores);
    ...
    if (combat_reports != null) builder.append(", combat_reports=").append(combat_reports);
  ...
  public static final class Builder extends Message.Builder<Star, Builder> {
    ...
    public List<EmpireStorage> empire_stores;
    ...
    public List<CombatReport> combat_reports;

    public Builder() {
      planets = Internal.newMutableList();
      empire_stores = Internal.newMutableList();
      fleets = Internal.newMutableList();
      combat_reports = Internal.newMutableList();
    }
     ...
     * collection of EmpireStorages details the presences of the empire(s) in this solar system.
     */
    public Builder empire_stores(List<EmpireStorage> empire_stores) {
      Internal.checkElementsNotNull(empire_stores);
      this.empire_stores = empire_stores;
      return this;
    }
    ...
    public Builder fleets(List<Fleet> fleets) {
      Internal.checkElementsNotNull(fleets);
      this.fleets = fleets;
      return this;
    }
     ...
     * A list of the recent CombatReports, detailing combat on this star.
     */
    public Builder combat_reports(List<CombatReport> combat_reports) {
      Internal.checkElementsNotNull(combat_reports);
      this.combat_reports = combat_reports;
      return this;
    }

    @Override
    public Star build() {
      return new Star(id, sector_x, sector_y, name, classification, size, offset_x, offset_y, planets, empire_stores, fleets, time_emptied, last_simulation, next_simulation, wormhole, combat_reports, buildUnknownFields());
    }
  }
  ...
  private static final class ProtoAdapter_Star extends ProtoAdapter<Star> {
    ...
    public int encodedSize(Star value) {
      return (value.id != null ? ProtoAdapter.INT64.encodedSizeWithTag(1, value.id) : 0)
          ...
          + EmpireStorage.ADAPTER.asRepeated().encodedSizeWithTag(14, value.empire_stores)
          ...
          + CombatReport.ADAPTER.asRepeated().encodedSizeWithTag(21, value.combat_reports)
          + value.unknownFields().size();
    }
    ...
    public void encode(ProtoWriter writer, Star value) throws IOException {
      ...
      if (value.empire_stores != null) EmpireStorage.ADAPTER.asRepeated().encodeWithTag(writer, 14, value.empire_stores);
      ...
      if (value.combat_reports != null) CombatReport.ADAPTER.asRepeated().encodeWithTag(writer, 21, value.combat_reports);
      writer.writeBytes(value.unknownFields());
    }
    ...
    public Star decode(ProtoReader reader) throws IOException {
      ...
      for (int tag; (tag = reader.nextTag()) != -1;) {
        switch (tag) {
          ...
          case 14: builder.empire_stores.add(EmpireStorage.ADAPTER.decode(reader)); break;
          ...
          case 21: builder.combat_reports.add(CombatReport.ADAPTER.decode(reader)); break;
          default: {
            FieldEncoding fieldEncoding = reader.peekFieldEncoding();
            Object value = fieldEncoding.rawProtoAdapter().decode(reader);
            builder.addUnknownField(tag, fieldEncoding, value);
    ...
    public Star redact(Star value) {
      ...
      Internal.redactElements(builder.empire_stores, EmpireStorage.ADAPTER);
      Internal.redactElements(builder.fleets, Fleet.ADAPTER);
      if (builder.wormhole != null) builder.wormhole = Wormhole.ADAPTER.redact(builder.wormhole);
      Internal.redactElements(builder.combat_reports, CombatReport.ADAPTER);
      builder.clearUnknownFields();
      return builder.build();
    }
  }
