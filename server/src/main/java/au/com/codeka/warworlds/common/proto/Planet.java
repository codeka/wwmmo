...
// Source file: au/com/codeka/warworlds/common/proto/star.proto at 124:1
...
public final class Planet extends Message<Planet, Planet.Builder> {
  ...
  @WireField(
      tag = 8,
      adapter = "au.com.codeka.warworlds.common.proto.Colony#ADAPTER"
  )
  public final Colony colony;

  public Planet(Integer index, PLANET_TYPE planet_type, Integer population_congeniality, Integer farming_congeniality, Integer mining_congeniality, Integer energy_congeniality, Colony colony) {
    this(index, planet_type, population_congeniality, farming_congeniality, mining_congeniality, energy_congeniality, colony, ByteString.EMPTY);
  }

  public Planet(Integer index, PLANET_TYPE planet_type, Integer population_congeniality, Integer farming_congeniality, Integer mining_congeniality, Integer energy_congeniality, Colony colony, ByteString unknownFields) {
  ...
  public boolean equals(Object other) {
    ...
    return Internal.equals(unknownFields(), o.unknownFields())
        ...
        && Internal.equals(colony, o.colony);
  }
  ...
  public int hashCode() {
    ...
    if (result == 0) {
      ...
      result = result * 37 + (colony != null ? colony.hashCode() : 0);
  ...
  public String toString() {
    ...
    if (colony != null) builder.append(", colony=").append(colony);
  ...
  public static final class Builder extends Message.Builder<Planet, Builder> {
     ...
     * Colony on this planet (if there is one).
     */
    public Builder colony(Colony colony) {
      this.colony = colony;
      return this;
    }
    ...
    @Override
    public Planet build() {
      return new Planet(index, planet_type, population_congeniality, farming_congeniality, mining_congeniality, energy_congeniality, colony, buildUnknownFields());
    }
  }
  ...
  private static final class ProtoAdapter_Planet extends ProtoAdapter<Planet> {
    ...
    public int encodedSize(Planet value) {
      return (value.index != null ? ProtoAdapter.INT32.encodedSizeWithTag(2, value.index) : 0)
          ...
          + (value.colony != null ? Colony.ADAPTER.encodedSizeWithTag(8, value.colony) : 0)
    ...
    public void encode(ProtoWriter writer, Planet value) throws IOException {
      ...
      if (value.colony != null) Colony.ADAPTER.encodeWithTag(writer, 8, value.colony);
    ...
    public Planet decode(ProtoReader reader) throws IOException {
      ...
      for (int tag; (tag = reader.nextTag()) != -1;) {
        switch (tag) {
          ...
          case 8: builder.colony(Colony.ADAPTER.decode(reader)); break;
          default: {
    ...
    public Planet redact(Planet value) {
      ...
      if (builder.colony != null) builder.colony = Colony.ADAPTER.redact(builder.colony);
