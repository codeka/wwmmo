...
// Source file: au/com/codeka/warworlds/common/proto/star.proto at 183:1
...
public final class StarModification extends Message<StarModification, StarModification.Builder> {
  ...
  public static final Long DEFAULT_FLEET_ID = 0L;
  ...
  public final List<Long> additional_fleet_ids;

  public StarModification(MODIFICATION_TYPE type, Long empire_id, Integer planet_index, Long colony_id, Long fleet_id, Long build_request_id, ColonyFocus focus, Design.DesignType design_type, Integer count, Long star_id, Fleet fleet, List<Long> additional_fleet_ids) {
    this(type, empire_id, planet_index, colony_id, fleet_id, build_request_id, focus, design_type, count, star_id, fleet, additional_fleet_ids, ByteString.EMPTY);
  }

  public StarModification(MODIFICATION_TYPE type, Long empire_id, Integer planet_index, Long colony_id, Long fleet_id, Long build_request_id, ColonyFocus focus, Design.DesignType design_type, Integer count, Long star_id, Fleet fleet, List<Long> additional_fleet_ids, ByteString unknownFields) {
    ...
    this.fleet = fleet;
    this.additional_fleet_ids = Internal.immutableCopyOf("additional_fleet_ids", additional_fleet_ids);
  }
  ...
  public Builder newBuilder() {
    ...
    builder.fleet = fleet;
    builder.additional_fleet_ids = Internal.copyOf("additional_fleet_ids", additional_fleet_ids);
  ...
  public boolean equals(Object other) {
    ...
    return Internal.equals(unknownFields(), o.unknownFields())
        ...
        && Internal.equals(fleet_id, o.fleet_id)
        ...
        && Internal.equals(fleet, o.fleet)
        && Internal.equals(additional_fleet_ids, o.additional_fleet_ids);
  }
  ...
  public int hashCode() {
    ...
    if (result == 0) {
      ...
      result = result * 37 + (fleet != null ? fleet.hashCode() : 0);
      result = result * 37 + (additional_fleet_ids != null ? additional_fleet_ids.hashCode() : 1);
  ...
  public String toString() {
    ...
    if (fleet_id != null) builder.append(", fleet_id=").append(fleet_id);
    ...
    if (fleet != null) builder.append(", fleet=").append(fleet);
    if (additional_fleet_ids != null) builder.append(", additional_fleet_ids=").append(additional_fleet_ids);
  ...
  public static final class Builder extends Message.Builder<StarModification, Builder> {
    ...
    public List<Long> additional_fleet_ids;

    public Builder() {
      additional_fleet_ids = Internal.newMutableList();
    }
    ...
    public Builder fleet_id(Long fleet_id) {
      this.fleet_id = fleet_id;
      return this;
    }
    ...
    public Builder additional_fleet_ids(List<Long> additional_fleet_ids) {
      Internal.checkElementsNotNull(additional_fleet_ids);
      this.additional_fleet_ids = additional_fleet_ids;
      return this;
    }

    @Override
    public StarModification build() {
      return new StarModification(type, empire_id, planet_index, colony_id, fleet_id, build_request_id, focus, design_type, count, star_id, fleet, additional_fleet_ids, buildUnknownFields());
    }
  }
  ...
  public enum MODIFICATION_TYPE implements WireEnum {
     ...
     * the new fleet will be a copy of the given fleet.
     */
    CREATE_FLEET(3),
    ...
    public static MODIFICATION_TYPE fromValue(int value) {
      switch (value) {
        ...
        case 6: return SPLIT_FLEET;
        case 7: return MERGE_FLEET;
        case 8: return MOVE_FLEET;
        case 9: return DELETE_BUILD_REQUEST;
        case 10: return EMPTY_NATIVE;
        default: return null;
      }
    }
  ...
  private static final class ProtoAdapter_StarModification extends ProtoAdapter<StarModification> {
    ...
    public int encodedSize(StarModification value) {
      return (value.type != null ? MODIFICATION_TYPE.ADAPTER.encodedSizeWithTag(1, value.type) : 0)
          ...
          + (value.fleet_id != null ? ProtoAdapter.INT64.encodedSizeWithTag(5, value.fleet_id) : 0)
          + (value.build_request_id != null ? ProtoAdapter.INT64.encodedSizeWithTag(12, value.build_request_id) : 0)
          + (value.focus != null ? ColonyFocus.ADAPTER.encodedSizeWithTag(6, value.focus) : 0)
          + (value.design_type != null ? Design.DesignType.ADAPTER.encodedSizeWithTag(7, value.design_type) : 0)
          + (value.count != null ? ProtoAdapter.INT32.encodedSizeWithTag(8, value.count) : 0)
          + (value.star_id != null ? ProtoAdapter.INT64.encodedSizeWithTag(9, value.star_id) : 0)
          + (value.fleet != null ? Fleet.ADAPTER.encodedSizeWithTag(10, value.fleet) : 0)
          + ProtoAdapter.INT64.asRepeated().encodedSizeWithTag(11, value.additional_fleet_ids)
    ...
    public void encode(ProtoWriter writer, StarModification value) throws IOException {
      ...
      if (value.fleet_id != null) ProtoAdapter.INT64.encodeWithTag(writer, 5, value.fleet_id);
      if (value.build_request_id != null) ProtoAdapter.INT64.encodeWithTag(writer, 12, value.build_request_id);
      if (value.focus != null) ColonyFocus.ADAPTER.encodeWithTag(writer, 6, value.focus);
      if (value.design_type != null) Design.DesignType.ADAPTER.encodeWithTag(writer, 7, value.design_type);
      if (value.count != null) ProtoAdapter.INT32.encodeWithTag(writer, 8, value.count);
      if (value.star_id != null) ProtoAdapter.INT64.encodeWithTag(writer, 9, value.star_id);
      if (value.fleet != null) Fleet.ADAPTER.encodeWithTag(writer, 10, value.fleet);
      if (value.additional_fleet_ids != null) ProtoAdapter.INT64.asRepeated().encodeWithTag(writer, 11, value.additional_fleet_ids);
    ...
    public StarModification decode(ProtoReader reader) throws IOException {
      ...
      for (int tag; (tag = reader.nextTag()) != -1;) {
        switch (tag) {
          ...
          case 5: builder.fleet_id(ProtoAdapter.INT64.decode(reader)); break;
          case 12: builder.build_request_id(ProtoAdapter.INT64.decode(reader)); break;
          case 6: builder.focus(ColonyFocus.ADAPTER.decode(reader)); break;
          case 7: {
            try {
          ...
          case 8: builder.count(ProtoAdapter.INT32.decode(reader)); break;
          case 9: builder.star_id(ProtoAdapter.INT64.decode(reader)); break;
          case 10: builder.fleet(Fleet.ADAPTER.decode(reader)); break;
          case 11: builder.additional_fleet_ids.add(ProtoAdapter.INT64.decode(reader)); break;
          default: {
    ...
    public StarModification redact(StarModification value) {
      ...
      if (builder.fleet != null) builder.fleet = Fleet.ADAPTER.redact(builder.fleet);
