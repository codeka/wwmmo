...
class SectorGenerator {
  ...
  private fun expandUniverse(numToGenerate: Int) {
    var numToGenerate = numToGenerate
    log.debug("Expanding universe by %d", numToGenerate)
    val coords: List<SectorCoord> = DataStore.Companion.i.sectors().findSectorsByState(SectorState.New, numToGenerate)
    for (coord in coords) {
      generate(Sector.Builder()
          .x(coord.x)
          .y(coord.y)
  ...
  companion object {
     ...
     */
    private val PLANET_TYPE_SLOT_BONUSES = arrayOf(intArrayOf(-20, 10, 20, -20, -20, 0, 10, 0, -10), intArrayOf(-10, 0, 10, -20, 0, 0, 0, 0, -10), intArrayOf(0, -10, -10, 0, 0, 0, 0, 0, 20), intArrayOf(10, -10, -20, 0, 10, 0, -10, 10, 25), intArrayOf(20, -20, -30, -10, 10, 0, -20, 10, 30), intArrayOf(20, -20, -40, -10, 0, 0, -30, 0, 5), intArrayOf(30, -20, -40, -10, 0, 0, -30, 0, 0))
    private val PLANET_TYPE_STAR_BONUSES = arrayOf(intArrayOf(-10, 0, 0, -10, 10, -10, 0, 10, 40), intArrayOf(-10, -5, -10, -10, 20, -10, 0, 20, 50), intArrayOf(-10, -5, -20, -10, 30, -10, 0, 30, 60), intArrayOf(-20, -15, -30, -10, 30, -5, 0, 40, 70), intArrayOf(-20, -15, -40, -10, 20, -5, 0, 40, 80), intArrayOf(-30, 20, 10, -10, -10, 0, -10, -10, -30), intArrayOf(-30, 30, 20, -10, -20, 0, -10, -10, -30))
    ...
    // applied.
    private val PLANET_POPULATION_BONUSES = doubleArrayOf( // #GasGiant #Radiated #Inferno #Asteroids #Water #Toxic #Desert #Swamp #Terran
        0.4, 0.4, 0.4, 0.0, 1.1, 0.6, 0.9, 0.9, 1.5
    )
    private val PLANET_FARMING_BONUSES = doubleArrayOf( // #GasGiant #Radiated #Inferno #Asteroids #Water #Toxic #Desert #Swamp #Terran
        0.4, 0.2, 0.2, 0.0, 1.4, 0.4, 0.6, 1.0, 1.2
    )
    private val PLANET_MINING_BONUSES = doubleArrayOf( // #GasGiant #Radiated #Inferno #Asteroids #Water #Toxic #Desert #Swamp #Terran
        0.8, 1.5, 1.0, 2.5, 0.3, 0.4, 0.6, 0.6, 0.8
    )
    private val PLANET_ENERGY_BONUSES = doubleArrayOf( // #GasGiant #Radiated #Inferno #Asteroids #Water #Toxic #Desert #Swamp #Terran
