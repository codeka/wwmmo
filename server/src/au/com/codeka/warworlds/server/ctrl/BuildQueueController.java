...
public class BuildQueueController {
    ...
    public void build(BuildRequest buildRequest) throws RequestException {
        ...
        try (SqlStmt stmt = db.prepare(sql, Statement.RETURN_GENERATED_KEYS)) {
            ...
            stmt.setInt(8, buildRequest.getExistingFleetID());
            stmt.setString(9, buildRequest.getUpgradeID());
            stmt.setInt(10, buildRequest.getCount());
            stmt.setDouble(11, buildRequest.getProgress(false));
            stmt.setDateTime(12, buildRequest.getStartTime());
            stmt.setDateTime(13, buildRequest.getEndTime());
            stmt.update();
