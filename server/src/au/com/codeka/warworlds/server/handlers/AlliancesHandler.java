...
public class AlliancesHandler extends RequestHandler {
  ...
  protected void get() throws RequestException {
    String hideDeadStr = getRequest().getParameter("hide_dead");
    boolean hideDead = false;
    if (hideDeadStr != null && hideDeadStr.equals("1")) {
      hideDead = true;
    }

    List<Alliance> alliances = new AllianceController().getAlliances(hideDead);
