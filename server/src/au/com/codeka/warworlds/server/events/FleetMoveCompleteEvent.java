...
public class FleetMoveCompleteEvent extends Event {
  ...
  public static void processFleet(
      int fleetID, Star srcStar, Star destStar, boolean addSitrep) throws RequestException {
    ...
    if (addSitrep) {
      ...
      Messages.SituationReport.MoveCompleteRecord.Builder move_complete_pb =
          Messages.SituationReport.MoveCompleteRecord.newBuilder();
      ...
      if (destStar.getCombatReport() != null
          && isFleetInCombatReport(fleet.getKey(), (CombatReport) destStar.getCombatReport())) {
  ...
  public static void fireFleetArrivedEvents(Star star, Fleet newFleet) {
    ...
    ArrayList<BaseFleetUpgrade> upgrades = new ArrayList<>(newFleet.getUpgrades());
