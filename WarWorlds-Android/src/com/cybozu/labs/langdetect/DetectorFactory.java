...
public class DetectorFactory {
    ...
    public static void loadProfile(AssetManager assetManager, String directory)
        ...
        int langsize = fileNames.length, index = 0;
        for(String fileName : fileNames) {
            ...
            try {
                ...
                LangProfile profile = new LangProfile(new JSONObject(json));
                addProfile(profile, index, langsize);
                ++index;
            } catch (JSONException e) {
                throw new LangDetectException(ErrorCode.FormatError, "profile format error in '" + fileName + "'");
            } catch (IOException e) {
                throw new LangDetectException(ErrorCode.FileLoadError, "can't open '" + fileName + "'");
            } finally {
                if (ins != null) {
                    try {
                        ins.close();
