...
/**
 * Class to be customised with app-specific data. The Eclipse plugin will set
...
public class Setup {
     ...
     * below.
     */
    private static final String APP_NAME = "warworldsmmo";
     ...
     */
    public static final String SENDER_ID = "warworlds.app-role@codeka.com.au";
}
